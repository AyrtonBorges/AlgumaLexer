...
1. Baixe o instalador do [site oficial](link_para_instalador).
2. Siga as instruções do instalador para concluir a instalação.

### macOS

1. Abra o terminal.
2. Instale o [Homebrew](https://brew.sh/) caso ainda não tenha instalado.
3. Execute o seguinte comando: `brew install nome_da_linguagem`.
...
2. Execute os seguintes comandos:
   ```
   sudo apt update
   sudo apt install nome_da_linguagem
   ```
